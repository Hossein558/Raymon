...
if (isingroup?.find {(it.name == "Managers")}) 
{
...
else 
{
    DatabaseUtil.withSql('Jira-DB') { sql ->
        ...
        throw new InvalidInputException("${issue.reporter.displayName.toString()} ، این وظیفه در انتظار تعیین وضعیت است. در صورت نیاز به اصلاح ${result} آن را در وضعیت اصلاح قرار خواهد داد.")
